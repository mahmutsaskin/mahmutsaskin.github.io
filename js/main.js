...
function showToast(message) {
    ...
    toast.className = 'fixed bottom-5 right-5 bg-slate-900 text-white px-6 py-4 rounded-2xl shadow-2xl z-50 transform transition-all duration-500 translate-y-24 opacity-0 font-medium flex items-center gap-3 border border-slate-700 max-w-sm sm:max-w-md';
